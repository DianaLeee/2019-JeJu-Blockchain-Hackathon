    ...
    return (
      <StyledCard>
        <LeftAlignedCardContent>
          ...
          <Image floated="left" size="tiny" src={dogFace} />
          <CardHeader
            title={this.props.itemList.name}
            description={
              "(" + this.gender + ", " + this.props.itemList.animalType + ")"
            }
          />
          <CardMeta title="생년월일" description={this.props.itemList.birth} />
          <CardMeta
            title="등록번호"
            description={this.props.itemList.animalID}
          />
