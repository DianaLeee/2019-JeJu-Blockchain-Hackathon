        ...
        <LeftDiv>
          <Form>
            <StyledFormField>
              ...
              <input
                value={this.props.globalStore.name}
                onChange={value =>
                  this.props.globalStore.updateName(value.target.value)
                }
                placeholder="최대 15자"
              />
            </StyledFormField>
            ...
            <StyledFormField>
              ...
              <StyledButton
                ...
                basic
                onClick={() => this.props.globalStore.genderClick("1")}
              >
                수컷
              </StyledButton>
              <StyledButton
                active={this.props.globalStore.gender === "2"}
                basic
                onClick={() => this.props.globalStore.genderClick("2")}
              >
                암컷
              </StyledButton>
            </StyledFormField>
            <StyledFormField>
              ...
              <StyledButton
                ...
                basic
                onClick={() => this.props.globalStore.neutralizationClick("1")}
              >
                예
              </StyledButton>
              <StyledButton
                active={this.props.globalStore.neutralization === "2"}
                basic
                onClick={() => this.props.globalStore.neutralizationClick("2")}
              >
                아니오
              </StyledButton>
            </StyledFormField>
